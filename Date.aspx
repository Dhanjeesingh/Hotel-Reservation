...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label1" runat="server" Text="Date ID"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label4" runat="server" Text="Week"></asp:Label>
                </td>
                <td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_date" DataSourceID="SqlDataSource1">
            <Columns>
                <asp:BoundField DataField="id_date" HeaderText="id_date" ReadOnly="True" SortExpression="id_date" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [date]"></asp:SqlDataSource>
    </form>
</body>
</html>
