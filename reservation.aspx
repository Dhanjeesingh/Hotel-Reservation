...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label2" runat="server" Text="Date ID"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label4" runat="server" Text="Hotelier ID"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label5" runat="server" Text="Number Of Overnight"></asp:Label>
                </td>
                <td>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Id_date" HeaderText="Id_date" SortExpression="Id_date" />
                <asp:BoundField DataField="id_city" HeaderText="id_city" SortExpression="id_city" />
                <asp:BoundField DataField="id_hotelier" HeaderText="id_hotelier" SortExpression="id_hotelier" />
                <asp:BoundField DataField="Number_of_overnight" HeaderText="Number_of_overnight" SortExpression="Number_of_overnight" />
